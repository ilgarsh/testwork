 ...
 * Generated at: 2017-10-03 11:22:29 UTC
...
return;
    ...
    try {
      ...
      out.write("                selectDiv(e);\r\n");
      out.write("                $.post(\"\", {\r\n");
      out.write("                    command: \"show_child\",\r\n");
      out.write("                    div_id: this.id,\r\n");
      out.write("                    success: function () {\r\n");
      out.write("                        e.currentTarget.classList.add('open');\r\n");
      out.write("                    }\r\n");
      out.write("                }, function (response) {\r\n");
      out.write("                    for (var i = 0; i < response.childs.length; i++) {\r\n");
      out.write("                        if (!document.getElementById(response.childs[i].id)) {\r\n");
      out.write("                            createDirectory(document.getElementById(response.id),\r\n");
      out.write("                                response.childs[i]);\r\n");
      out.write("                        }\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
